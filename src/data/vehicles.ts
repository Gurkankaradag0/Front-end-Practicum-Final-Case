import Sand_Crawler from '~/assets/vehicles/Sand Crawler.webp'
import AT_ST from '~/assets/vehicles/AT-ST.webp'
import TIE_IN from '~/assets/vehicles/TIE_IN interceptor.webp'
import Armored_Aslt_Tank from '~/assets/vehicles/Armored Assault Tank.webp'
import STAP from '~/assets/vehicles/Single Trooper Aerial Platform.webp'
import C_9979 from '~/assets/vehicles/C-9979 landing craft.webp'
import Tribubble from '~/assets/vehicles/Tribubble bongo.webp'
import SithSpeeder from '~/assets/vehicles/Sith speeder.webp'
import Zephyr_G from '~/assets/vehicles/Zephyr-G swoop bike.webp'
import Koro_2 from '~/assets/vehicles/Koro-2 Exodrive.webp'
import FireSpeeder from '~/assets/vehicles/Emergency Firespeeder.webp'
import DroidTriFighter from '~/assets/vehicles/Droid tri-fighter.webp'
import Oevvaor from '~/assets/vehicles/Oevvaor jet catamaran.webp'
import RGFC from '~/assets/vehicles/Raddaugh Gnasp fluttercraft.webp'
import DGunShip from '~/assets/vehicles/Droid gunship.webp'
