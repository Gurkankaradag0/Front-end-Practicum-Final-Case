...
const SearchInput = ({ setInputFocus }: SearchInputProps) => {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <p className={`${focus || width < 512 ? 'hidden' : 'uppercase font-bold m-auto text-white/75 group-hover:text-white'}`}>Search</p>
                    <input
                        className={classNames({
