        ...
        <div className="relative w-full h-full z-10 flex box-content">
          <div className="w-full h-full relative shrink-0">
            <div className="h-full flex items-center w-full overflow-hidden relative rounded-[30px]">
              <img src="https://res.cloudinary.com/muhammederdem/image/upload/q_60/v1536405222/starwars/item-1-bg.webp" alt={result.name} className="rounded-[30px] absolute top-0 left-0 w-full h-full block object-cover" />
